...
public class FoodDataMixin {
    ...
    private boolean disableNaturalRegenIfDowned(GameRules instance, GameRules.Key<GameRules.BooleanValue> key, Operation<Boolean> original, @Local(argsOnly = true) Player player) {
